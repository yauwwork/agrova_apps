...
class _TambahProduk extends State<TambahProduk> {
  ...
  final TextEditingController deskripsiController = TextEditingController(
    text:
        "Apel segar langsung dari kebun di Malang. Dibudidayakan secara organik tanpa pestisida kimia. Manis, renyah, dan kaya akan nutrisi.",
  );
