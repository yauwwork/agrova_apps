...
class EditProfilPenjual extends StatefulWidget {
  const EditProfilPenjual({super.key});

  @override
  State<EditProfilPenjual> createState() => _EditProfilPenjualState();
}

class _EditProfilPenjualState extends State<EditProfilPenjual> {
  ...
  Future<void> _pickImage() async {
    try {
      ...
      final pickedFile = await picker.pickImage(
        ...
        imageQuality: 25, // Kompresi agar base64 tidak terlalu besar
        maxWidth: 500,
        maxHeight: 500,
      );
  ...
  Future<void> _saveProfile() async {
    ...
    try {
      ...
      _showSnack("Profil penjual berhasil diperbarui");
      if (mounted) {
                  ...
                  Container(
                    ...
                    child: CircleAvatar(
                      ...
                      child: _imageFile == null && (_currentPhotoBase64 == null || _currentPhotoBase64!.isEmpty)
                          ? const Icon(Icons.store, size: 65, color: Colors.grey)
                          : null,
                    ),
                  ),
                  Positioned(
